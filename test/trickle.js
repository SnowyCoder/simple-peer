...
test('disable trickle', function (t) {
  ...
  const peer1 = new Peer({ config, initiator: true, trickle: false })
  const peer2 = new Peer({ config, trickle: false })
...
test('null end candidate does not throw', function (t) {
  const peer1 = new Peer({ trickle: true, config, initiator: true  })
  const peer2 = new Peer({ trickle: true, config })
